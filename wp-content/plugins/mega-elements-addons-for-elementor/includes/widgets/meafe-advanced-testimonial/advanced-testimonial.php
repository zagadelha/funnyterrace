...
class MEAFE_Advanced_Testimonial extends Widget_Base
{
    ...
    protected function render() {
        ...
        ?>
        <div id=<?php echo esc_attr( $widget_id ); ?> class="meafe-adv-testimonial-main layout-<?php echo $settings['adv_testimonial_layouts']; ?> content-align-<?php echo esc_attr($settings['adv_testimonial_content_alignment']); ?>">
                                ...
                                <div class="meafe-testimonial-desc-wrap">
                                    <?php if( $testimonial['adv_testimonial_title'] ) : ?>
                                        <div <?php $this->print_render_attribute_string( 'adv_testimonial_title' ); ?>>
                                            <h2 class="meafe-entry-title"> <?php echo $testimonial['adv_testimonial_title']; ?> </h2>
                                        </div>
                                    <?php endif; ?>
                                    <?php if( $testimonial['adv_testimonial_content'] ) : ?>
                                        <div <?php $this->print_render_attribute_string( 'adv_testimonial_content' ); ?>>
                                            <?php echo $testimonial['adv_testimonial_content']; ?>
                                        </div>
                                    <?php endif; ?>
                                </div>
                                <div class="meafe-testimonial-tst-inner-wrap">
                                    ...
                                    <div class="meafe-adv-testimonial-name-wrap">
                                        <?php if( $testimonial['adv_testimonial_name'] ) : ?>
                                            <div <?php $this->print_render_attribute_string( 'adv_testimonial_name' ); ?>><?php echo $testimonial['adv_testimonial_name']; ?></div>
                                        <?php endif; ?>
                                        <?php if( $testimonial['adv_testimonial_position'] ) : ?>
                                            <div <?php $this->print_render_attribute_string( 'adv_testimonial_position' ); ?>><?php echo $testimonial['adv_testimonial_position']; ?></div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
