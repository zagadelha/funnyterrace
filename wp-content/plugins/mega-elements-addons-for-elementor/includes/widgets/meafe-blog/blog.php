                    ...
                    <div class="meafe-blog-card-inner">';
                        if ( has_post_thumbnail() && $settings['bbcls_blog_show_image'] == 'yes') {
                            ...
                            if ( $settings['bbcls_blog_layout_mode'] === '5' ){
                                ...
                                <div class="meafe-posted-on meafe-day"><time datetime="' . get_the_date() . '">' . date_i18n( esc_html__( 'd ', 'mega-elements-addons-for-elementor' ), strtotime( get_the_date() ) ). '</time></div>
                            <div class="meafe-posted-on meafe-time"><time datetime="' . get_the_date() . '">' . date_i18n( esc_html__( 'M', 'mega-elements-addons-for-elementor' ), strtotime( get_the_date() ) ). '</time></div></div>';
                            }
                            echo '</figure>';
                        }
                        echo '<div class="meafe-entry-wrapper category--main">';
                            ...
                            echo '<div class="meafe-entry-meta details">';
                                ...
                                if ( $settings['bbcls_blog_layout_mode'] !== '5' ){
                                        if ( $settings['bbcls_blog_show_date'] ) echo '<div class="meafe-posted-on meafe-date"><time datetime="' . get_the_date() . '">' . get_the_date() . '</time></div>';
                                }
                            ...
                            if ( $settings['bbcls_blog_show_read_more_button'] && $settings['bbcls_blog_read_more_button_text'] ) {
                                $fill_color = ( isset( $settings['bbsrms_blog_read_more_btn_color'] ) && $settings['bbsrms_blog_read_more_btn_color'] ) ? $settings['bbsrms_blog_read_more_btn_color'] : "#5081f5";
    ...
    protected function render()
    {
        ...
        if ( 'yes' == $settings['bbcls_blog_show_load_more'] && $settings['bbcls_blog_show_load_more_text'] && $settings['bbcls_blog_show_load_more_url']  ) {
            echo '<div class="meafe-load-more-button-wrap">
                <a href="' . esc_url($settings['bbcls_blog_show_load_more_url']) . '" class = "meafe-load-more-button">' . $settings['bbcls_blog_show_load_more_text'] . '</a>
            </div>';
        }
    }
