                    ...
                    if ( $settings['PC_layout_mode'] == '1'){
                        ...
                        echo '<div class="meafe-entry-wrapper">';
                            ...
                            echo '<div class="meafe-entry-meta details">';
                                ...
                                if ( $settings['PC_show_date'] ) echo '<div class="meafe-posted-on meafe-date"><time datetime="' . get_the_date() . '">' . get_the_date() . '</time></div>';
                            ...
                            if ( $settings['PC_show_read_more_button'] && $settings['PC_read_more_button_text'] ) {
                                ...
                                echo '<a href="' . esc_url( get_the_permalink() ) . '" class="meafe-post-elements-readmore-btn">' . esc_attr( $settings['PC_read_more_button_text'] ) . '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    protected function render()
    {
        ...
        $this->add_render_attribute(
            ...
            [
                ...
                'class' => [
                    'meafe-post-carousel-wrapper layout-' . $settings['PC_layout_mode'],
                ],
            ]
        );
