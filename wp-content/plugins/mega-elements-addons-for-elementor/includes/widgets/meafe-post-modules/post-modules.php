    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .meafe-post-modules-card-inner' => 'background-color: {{VALUE}}',
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .meafe-post-modules-card' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                    '{{WRAPPER}} .meafe-post-modules-wrapper' => 'margin-left: -{{LEFT}}{{UNIT}}; margin-right: -{{RIGHT}}{{UNIT}}'
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector'  => '{{WRAPPER}} .meafe-post-modules-card-inner',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::DIMENSIONS,
                'selectors' => [
                    '{{WRAPPER}} .meafe-post-modules-card-inner' => 'border-radius: {{TOP}}px {{RIGHT}}px {{BOTTOM}}px {{LEFT}}px',
                ],
            ]
        );
        ...
        while( $modules_query->have_posts() ) {
            ...
            if( $modules_query->current_post % $image_num == 0 ){
                echo '<div class="meafe-post-modules items-left">';
                    $image_size ='meafe-post-modules-large-img';
                ...
                <div class="meafe-post-modules-card-inner">
                    ...
                    <div class="meafe-entry-wrapper category--main">
                        ...
                        <div class="meafe-entry-meta details">
                            ...
                            if ( $settings['PM_show_date'] ) echo '<div class="meafe-posted-on meafe-date"><time datetime="' . get_the_date() . '">' . get_the_date() . '</time></div>'; ?>
                        </div>
                    </div>
                </div>
            </div>
    ...
    protected function render()
    {
        ...
        $this->add_render_attribute(
            ...
            [
                ...
                'class' => [
                    'meafe-post-modules-wrapper layout-' . $settings['PM_layout_mode'],
                ],
            ]
        );
