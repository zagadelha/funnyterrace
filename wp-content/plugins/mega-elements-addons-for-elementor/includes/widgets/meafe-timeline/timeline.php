...
class MEAFE_Timeline extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        */
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block'   => false,
                'options'       => [
                    '1'       => esc_html__( 'Vertical', 'mega-elements-addons-for-elementor' ),
                    '2'       => esc_html__( 'Horizontal', 'mega-elements-addons-for-elementor' ),
                ],
        ...
        */
        $this->start_controls_section(
            'meafe_timeline_style_general_style',
            [
        ...
        /**
         * Timeline Divider and Icon
        */
        $this->start_controls_section(
            'meafe_timeline_style_divider_style',
            [
                'label'     => __( 'Divider & Icons', 'mega-elements-addons-for-elementor' ),
                'tab'       => Controls_Manager::TAB_STYLE,
            ]
        );
		
        $this->add_control(
            'btcsgs_timeline_divider_color',
            [
                'label'     => __( 'Divider Color', 'mega-elements-addons-for-elementor' ),
                'default'   => '#f3f3f3',
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .meafe-timeline-main .meafe-timeline-wrap::after' => 'background-color: {{VALUE}}',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .meafe-timeline-main .meafe-timeline-icon' => 'font-size: {{SIZE}}{{UNIT}}'
                ],
            ]
        );

        $this->add_responsive_control(
            'btcsgs_timeline_divider_width',
            [
                'label' => __( 'Divider Size', 'mega-elements-addons-for-elementor' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .meafe-timeline-main .meafe-timeline-wrap::after' => 'width: {{SIZE}}{{UNIT}};',
                ],
				'condition' => [
                    'btccgs_timeline_layouts' => '1'
                ],
            ]
        );

		$this->add_responsive_control(
            'btcsgs_timeline_divider_height',
            [
                'label' => __( 'Divider Size', 'mega-elements-addons-for-elementor' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .meafe-timeline-main .meafe-timeline-wrap::after' => 'height: {{SIZE}}{{UNIT}};',
                ],
				'condition' => [
                    'btccgs_timeline_layouts' => '2'
                ],
        ...
        */
        ...
        $this->add_responsive_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				// 'condition' => [
				// 	'btcsis_timeline_image_height[size]!' => '',
				// ],
				'options' => [
    ...
    public function get_nav_details(){
        ...
        if( $nav === 'yes' ) {
            ...
            if ( $nav_prev['library'] != 'svg' && $nav_next['library'] == 'svg' ){
                ...
                array_push($return_all, '<img src="' . $nav_next['value']['url'] . '">');
                return $return_all;
            }
            ...
            if ( $nav_prev['library'] == 'svg' && $nav_next['library'] != 'svg' ){
                ...
                array_push($return_alls, '<img src="' . $nav_prev['value']['url'] . '">');
                array_reverse($return_alls);
                return $return_alls;
            }   
        }
    ...
    protected function render() {
        $settings  = $this->get_settings_for_display();
        $layout    = $settings['btccgs_timeline_layouts'];
        ...
        ?>
        <div id="<?php echo esc_attr( $this->get_id() ); ?>" class="meafe-timeline-main layout-<?php echo esc_attr($layout); ?> center-aligned-content">
            <div class="meafe-timeline-wrap">
                <?php 
                if($layout === '2') echo '<div class="swiper-container"><div class="swiper-wrapper">';
                    foreach ( $settings[ 'btccgs_timeline'] as $index => $timeline ) { ?>
                        <div class="meafe-timeline-inner-wrap <?php if($layout === '2') echo 'swiper-slide'; ?>">
                            ...
                            <div class="meafe-timeline-meta-wrap">
                                <?php if($layout === '1'){ 
                                    ...
                                    <div <?php $this->print_render_attribute_string( 'btccgs_timeline_date' ); ?> >
                                        <<?php echo $settings['btccgs_timeline_date_tag']; ?>>
                                            <?php echo $timeline['btccgs_timeline_date']; ?>
                                        </<?php echo $settings['btccgs_timeline_date_tag']; ?>>
                                    </div>
                                    <?php endif; 
                                    ...
                                    if( $timeline['btccgs_timeline_title'] ) : ?>
                                        <div <?php $this->print_render_attribute_string( 'btccgs_timeline_title' ); ?>>
                                            <<?php echo $settings['btccgs_timeline_title_tag']; ?>>
                                                <?php echo $timeline['btccgs_timeline_title']; ?>
                                            </<?php echo $settings['btccgs_timeline_title_tag']; ?>>
                                        </div>
                                    <?php endif; 
                                    ...
                                    if( $timeline['btccgs_timeline_content'] ) : ?>
                                        <div <?php $this->print_render_attribute_string( 'btccgs_timeline_content' ); ?>>
                                            <?php echo $timeline['btccgs_timeline_content']; ?>
                                        </div>
                                    <?php endif; 
                                } else{
                                    if( $timeline['btccgs_timeline_title'] ) : ?>
