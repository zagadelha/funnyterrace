...
class MEAFE_Testimonial extends Widget_Base
{
    ...
    protected function render() {
        ...
        ?>
        <div class="meafe-testimonial-main layout-<?php echo $settings['btcgs_testimonial_layouts']; ?> <?php echo $settings['btcgs_testimonial_alignment']; ?>-aligned-content">
            <div class="meafe-testimonial-inner-wrap position-<?php echo $settings['btsgs_testimonial_ribbon_position']; ?>">
                                ...
                                <?php if( $settings['btcrs_testimonial_rating_enable'] ) : ?>
                                    <div class="elementor-star-rating__wrapper">
                                        <?php if ( ! Utils::is_empty( $settings['btcrs_testimonial_title'] ) ) : ?>
                                            <div class="elementor-star-rating__title"><?php echo $settings['btcrs_testimonial_title']; ?></div>
                                        <?php endif; ?>
    ...
    protected function content_template() {
        ...
        <div class="meafe-testimonial-main layout-{{{settings.btcgs_testimonial_layouts}}} {{{settings.btcgs_testimonial_alignment}}}-aligned-content">
