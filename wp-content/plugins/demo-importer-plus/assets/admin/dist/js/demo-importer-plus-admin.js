...
(function ($) {
  ...
  DemoImporterPlus = (_DemoImporterPlus = {
  ...
  }, _defineProperty(_DemoImporterPlus, "isEmpty", function isEmpty(obj) {
    for (var key in obj) {
      if (obj.hasOwnProperty(key)) return false;
    }
    return true;
  }), _defineProperty(_DemoImporterPlus, "_unescape", function _unescape(input_string) {
    var title = _.unescape(input_string);
    ...
    title = title.replace("&#8217;", "'");
    return title;
  }), _defineProperty(_DemoImporterPlus, "_unescape_lower", function _unescape_lower(input_string) {
    var input_string = DemoImporterPlus._unescape(input_string);
    return input_string.toLowerCase();
  }), _defineProperty(_DemoImporterPlus, "_set_preview_screenshot_by_page", function _set_preview_screenshot_by_page(element) {
  ...
  }), _defineProperty(_DemoImporterPlus, "_change_site_preview_screenshot", function _change_site_preview_screenshot(event) {
    event.preventDefault();
    var item = $(event.currentTarget);
    DemoImporterPlus._set_preview_screenshot_by_page(item);
  }), _defineProperty(_DemoImporterPlus, "_change_page_builder", function _change_page_builder(event) {
  ...
  }), _defineProperty(_DemoImporterPlus, "show_page_popup_from_search", function show_page_popup_from_search(event) {
    event.preventDefault();
  ...
  }), _defineProperty(_DemoImporterPlus, "_get_id", function _get_id(site_id) {
    return site_id.replace("id-", "");
  }), _defineProperty(_DemoImporterPlus, "show_page_popup", function show_page_popup() {
    DemoImporterPlus.process_import_page();
  }), _defineProperty(_DemoImporterPlus, "_show_site_popup", function _show_site_popup(event) {
    event.preventDefault();
  ...
  }), _defineProperty(_DemoImporterPlus, "_resetData", function _resetData() {
  ...
  }), _defineProperty(_DemoImporterPlus, "_installTheme", function _installTheme(status) {
  ...
  }), _defineProperty(_DemoImporterPlus, "_activateTheme", function _activateTheme(event, response) {
    // WordPress adds "Activate" button after waiting for 1000ms. So we will run our activation after that.
    setTimeout(function () {
      $.ajax({
        url: demoImporterVars.ajaxurl,
  ...
  }), _defineProperty(_DemoImporterPlus, "_start_site_import", function _start_site_import() {
  ...
  }), _defineProperty(_DemoImporterPlus, "_is_reset_data", function _is_reset_data() {
    if ($(".demo-importer-plus-reset-data").find(".checkbox").is(":checked")) {
      return true;
    }
    return false;
  }), _defineProperty(_DemoImporterPlus, "_is_process_xml", function _is_process_xml() {
    if ($(".demo-importer-plus-import-xml").find(".checkbox").is(":checked")) {
      return true;
    }
    return false;
  }), _defineProperty(_DemoImporterPlus, "_is_process_customizer", function _is_process_customizer() {
    ...
    return false;
  }), _defineProperty(_DemoImporterPlus, "_is_process_widgets", function _is_process_widgets() {
    if ($(".demo-importer-plus-import-widgets").find(".checkbox").is(":checked")) {
      return true;
    }
    return false;
  }), _defineProperty(_DemoImporterPlus, "_startImportCartFlows", function _startImportCartFlows(event) {
  ...
  }), _defineProperty(_DemoImporterPlus, "_startImportContactForms", function _startImportContactForms(event) {
  ...
  }), _defineProperty(_DemoImporterPlus, "_importCustomizerSettings", function _importCustomizerSettings(event) {
  ...
  }), _defineProperty(_DemoImporterPlus, "_importXML", function _importXML() {
  ...
  }), _defineProperty(_DemoImporterPlus, "import_siteOptions", function import_siteOptions(event) {
    if (DemoImporterPlus._is_process_xml()) {
      $.ajax({
        url: demoImporterVars.ajaxurl,
        type: "POST",
  ...
  }), _defineProperty(_DemoImporterPlus, "_importWidgets", function _importWidgets(event) {
  ...
  }), _defineProperty(_DemoImporterPlus, "_importEnd", function _importEnd(event) {
    $.ajax({
      url: demoImporterVars.ajaxurl,
      type: "POST",
      dataType: "json",
  ...
  }), _defineProperty(_DemoImporterPlus, "import_complete", function import_complete() {
  ...
  }), _defineProperty(_DemoImporterPlus, "_importSuccessButton", function _importSuccessButton() {
  ...
  }), _defineProperty(_DemoImporterPlus, "add_skip_and_import_popups", function add_skip_and_import_popups(templates) {
  ...
  }), _defineProperty(_DemoImporterPlus, "process_site_data", function process_site_data(data) {
    if ("log_file" in data) {
  ...
  }), _defineProperty(_DemoImporterPlus, "template_kit_markup", function template_kit_markup(data) {
    if ("elementor" != demoImporterVars.default_page_builder) {
      return;
    }
  }), _defineProperty(_DemoImporterPlus, "hide_popup", function hide_popup() {
    $(".demo-importer-plus-popup").hide();
  }), _defineProperty(_DemoImporterPlus, "process_import_page", function process_import_page() {
    DemoImporterPlus.hide_popup();
  ...
  }), _defineProperty(_DemoImporterPlus, "_backup_before_rest_options", function _backup_before_rest_options() {
  ...
  }), _defineProperty(_DemoImporterPlus, "_recheck_backup_options", function _recheck_backup_options() {
    DemoImporterPlus._backupOptions("demo-importer-plus-backup-settings-done");
    DemoImporterPlus.backup_taken = true;
  }), _defineProperty(_DemoImporterPlus, "_backupOptions", function _backupOptions(trigger_name) {
  ...
  }), _defineProperty(_DemoImporterPlus, "_reset_customizer_data", function _reset_customizer_data() {
    $.ajax({
      url: demoImporterVars.ajaxurl,
      type: "POST",
      data: {
  ...
  }), _defineProperty(_DemoImporterPlus, "_reset_site_options", function _reset_site_options() {
    // Site Options.
    $.ajax({
      url: demoImporterVars.ajaxurl,
      type: "POST",
  ...
  }), _defineProperty(_DemoImporterPlus, "_reset_widgets_data", function _reset_widgets_data() {
    // Widgets.
    $.ajax({
      url: demoImporterVars.ajaxurl,
      type: "POST",
  ...
  }), _defineProperty(_DemoImporterPlus, "_reset_posts", function _reset_posts() {
  ...
  }), _defineProperty(_DemoImporterPlus, "_reset_contact_form7", function _reset_contact_form7() {
  ...
  }), _defineProperty(_DemoImporterPlus, "_reset_terms", function _reset_terms() {
  ...
  }), _defineProperty(_DemoImporterPlus, "_bulkPluginInstallActivate", function _bulkPluginInstallActivate() {
  ...
  }), _defineProperty(_DemoImporterPlus, "_activateAllPlugins", function _activateAllPlugins(activate_plugins) {
    ...
    DemoImporterAjaxQueue.run();
  }), _defineProperty(_DemoImporterPlus, "_enable_demo_import_button", function _enable_demo_import_button(type) {
  ...
  }), _defineProperty(_DemoImporterPlus, "_installAllPlugins", function _installAllPlugins(not_installed) {
    ...
    wp.updates.queueChecker();
  }), _defineProperty(_DemoImporterPlus, "import_page_process", function import_page_process() {
    ...
    // Process Bulk Plugin Install & Activate.
    DemoImporterPlus._bulkPluginInstallActivate();
  }), _defineProperty(_DemoImporterPlus, "required_plugins_list_markup", function required_plugins_list_markup(requiredPlugins) {
    if ("" === requiredPlugins) {
      return;
    }
  ...
  }), _defineProperty(_DemoImporterPlus, "_page_api_call", function _page_api_call() {
    if (Object.keys(DemoImporterPlus.skip_and_import_popups).length) {
      return;
    }
  ...
  }), _defineProperty(_DemoImporterPlus, "_insertDemo", function _insertDemo(data) {
  ...
  }), _defineProperty(_DemoImporterPlus, "import_contact_form7", function import_contact_form7(contact_form, callback) {
  ...
  }), _defineProperty(_DemoImporterPlus, "show_page_popup_from_sites", function show_page_popup_from_sites(e) {
    e.preventDefault();
    if ($(this).hasClass("updating-message")) {
      return;
    }
  ...
  }), _defineProperty(_DemoImporterPlus, "show_pages_by_site_id", function show_pages_by_site_id(site_id, page_id) {
  ...
  }), _defineProperty(_DemoImporterPlus, "_removePluginFromQueue", function _removePluginFromQueue(removeItem, pluginsList) {
